...
def bubble():
    ...
    class PageThree3(Frame):
        def __init__(self, parent, controller):
            ...
            page_two = Button(self, text="Default", font='Times 17 bold', padx=30, pady=10, command=bubblesort.bubblesort)
            page_two.pack(pady=10)
            page_three = Button(self, text="By User", font='Times 17 bold', padx=30, pady=10, command=lambda:controller.show_frame(byuser))
    ...
    class byuser(Frame):
            def __init__(self, parent, controller):
                ...
                def showbox():
                    ...
                    btn = Button(self, text="SUBMIT", font='Times 17 bold', padx=30, pady=10, command=lambda: [input1(), bubblesort.bubblesort()])
                    btn.grid(row=3,columnspan=x, pady=70)

                btn = Button(self, text="SUBMIT", font='Times 17 bold', padx=30, pady=10,
                             command=lambda: [input2(), showbox()])
