...
def traversal2():
    ...
    text = font.render('LINEAR SEARCH', True, (255, 255, 255))
    text2 = font2.render('(Press SPACE-BAR to proceed to visualization of linear-search process)', True, (255, 255, 255))
    ...
    while run:
        ...
        if keys[pygame.K_SPACE]:
            ...
            if flag==-1:
                ...
                some='The element is present at index: '+str(flag)
